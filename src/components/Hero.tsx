                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                            Professionell, schnell und zuverlässig. Wir erledigen Ihren Umzug, Transport oder Entrümpelung – stressfrei und zum fairen Preis.
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-2">
                            <div className="flex items-center gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                                ...
                                <div className="text-sm font-bold text-gray-700 dark:text-gray-200 leading-tight">Schneller<br />Transport</div>
                            </div>
                            <div className="flex items-center gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                                <div className="text-2xl">🛡️</div>
                                <div className="text-sm font-bold text-gray-700 dark:text-gray-200 leading-tight">Voll<br />Versichert</div>
                            </div>
                            <div className="flex items-center gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                                <div className="text-2xl">💶</div>
                                <div className="text-sm font-bold text-gray-700 dark:text-gray-200 leading-tight">Faire<br />Preise</div>
                            </div>
                        </div>
                    </div>
