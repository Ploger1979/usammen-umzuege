    ...
    if (success) {
        return (
            <div className="bg-white dark:bg-gray-800 p-12 rounded-2xl shadow-lg text-center transition-colors duration-300">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Anfrage versendet!</h2>
                <p className="text-xl text-gray-600 dark:text-gray-300">Wir haben Ihre Daten erhalten und erstellen Ihr Angebot. <br />Sie hören in Kürze von uns.</p>
            </div>
        );
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-6 md:p-10 rounded-2xl shadow-xl space-y-10 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
            ...
            <section className="space-y-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">1. Umzugsart & Services</h3>
                <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer text-gray-900 dark:text-gray-200">
                        ...
                        <span className="text-lg">Privatumzug</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer text-gray-900 dark:text-gray-200">
                        ...
                        <span className="text-lg">Firmenumzug</span>
                    </label>
                </div>

                <div className="grid md:grid-cols-2 gap-4">
                    {['Umzug', 'Entrümpelung', 'Transport', 'Packservice'].map(s => (
                        <label key={s} className="flex items-center gap-2 p-3 border dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-gray-700 dark:text-gray-200 transition-colors">
                            <input type="checkbox" name="services" value={s} className="w-5 h-5 rounded text-primary focus:ring-primary bg-gray-50 dark:bg-gray-700 border-gray-300 dark:border-gray-600" />
                            <span>{s}</span>
                        </label>
                    ))}
                </div>
            ...
            {/* Step 2: Addresses */}
            <section className="space-y-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">2. Adressen & Gegebenheiten</h3>
                <div className="grid md:grid-cols-2 gap-8">
                    {/* From */}
                    <div className="space-y-4">
                        <h4 className="font-semibold text-primary-700 dark:text-primary-400">Abholadresse</h4>
                        <input required name="addressFrom" placeholder="Straße, Nr, PLZ, Ort" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                        <div className="flex gap-4">
                            <div className="w-1/2">
                                <label className="text-xs text-gray-500 dark:text-gray-400 block mb-1">Etage</label>
                    ...
                    {/* To */}
                    <div className="space-y-4">
                        <h4 className="font-semibold text-secondary dark:text-secondary-400">Zieladresse</h4>
                        <input required name="addressTo" placeholder="Straße, Nr, PLZ, Ort" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                        <div className="flex gap-4">
                            <div className="w-1/2">
                                <label className="text-xs text-gray-500 dark:text-gray-400 block mb-1">Etage</label>
                ...
                <div className="flex flex-wrap gap-6 pt-2">
                    <label className="flex items-center gap-2 cursor-pointer text-gray-700 dark:text-gray-200">
                        ...
                        <span>Halteverbotszone / Parkplatz reservieren?</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer text-gray-700 dark:text-gray-200">
                        ...
                        <span>Montage/Demontage gewünscht?</span>
                    </label>
                </div>
            </section>
            ...
            {/* Step 4: Items */}
            <section className="space-y-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">4. Umzugsgut (Auszug)</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Bitte geben Sie große Möbelstücke an.</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className={`p-4 border rounded-lg transition ${items.washing_machine.active ? 'border-primary bg-primary-50 dark:bg-primary-900/20 dark:border-primary-500' : 'bg-white dark:bg-gray-700 dark:border-gray-600'}`}>
                        <label className="flex items-center gap-3 cursor-pointer text-gray-900 dark:text-gray-200">
                            ...
                            <span className="font-semibold">Waschmaschine</span>
                        </label>
                        {items.washing_machine.active && (
                            <div className="mt-2 ml-8 text-gray-700 dark:text-gray-300">
                                <label className="text-sm mr-2">Anzahl:</label>
                    ...
                    <div className={`p-4 border rounded-lg transition ${items.dryer.active ? 'border-primary bg-primary-50 dark:bg-primary-900/20 dark:border-primary-500' : 'bg-white dark:bg-gray-700 dark:border-gray-600'}`}>
                        <label className="flex items-center gap-3 cursor-pointer text-gray-900 dark:text-gray-200">
                            ...
                            <span className="font-semibold">Trockner</span>
                        </label>
                        {items.dryer.active && (
                            <div className="mt-2 ml-8 text-gray-700 dark:text-gray-300">
                                <label className="text-sm mr-2">Anzahl:</label>
                    ...
                    <div className={`p-4 border rounded-lg transition ${items.bed.active ? 'border-primary bg-primary-50 dark:bg-primary-900/20 dark:border-primary-500' : 'bg-white dark:bg-gray-700 dark:border-gray-600'}`}>
                        <label className="flex items-center gap-3 cursor-pointer text-gray-900 dark:text-gray-200">
                            ...
                            <span className="font-semibold">Bett</span>
                        </label>
                        {items.bed.active && (
                            <div className="mt-2 ml-8 flex flex-wrap gap-4 items-center text-gray-700 dark:text-gray-300">
                                ...
                                <div>
                                    <label className="text-sm mr-2">Größe:</label>
                                ...
                                {items.bed.bedSize === 'custom' && (
                                    <div className="flex gap-2">
                                        <input placeholder="Breite" value={items.bed.width || ''} onChange={(e) => updateItem('bed', { width: e.target.value })} className="w-20 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                        <input placeholder="Länge" value={items.bed.length || ''} onChange={(e) => updateItem('bed', { length: e.target.value })} className="w-20 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                    </div>
                                )}
                            </div>
                        )}
                    ...
                    <div className={`p-4 border rounded-lg transition ${items.table.active ? 'border-primary bg-primary-50 dark:bg-primary-900/20 dark:border-primary-500' : 'bg-white dark:bg-gray-700 dark:border-gray-600'}`}>
                        <label className="flex items-center gap-3 cursor-pointer text-gray-900 dark:text-gray-200">
                            ...
                            <span className="font-semibold">Tisch</span>
                        </label>
                        {items.table.active && (
                            <div className="mt-2 ml-8 flex flex-wrap gap-4 items-center text-gray-700 dark:text-gray-300">
                                <div>
                                ...
                                <div className="flex gap-2 items-center">
                                    <span className="text-sm">Maße:</span>
                                    <input placeholder="Breite (cm)" value={items.table.width || ''} onChange={(e) => updateItem('table', { width: e.target.value })} className="w-24 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                    <input placeholder="Länge (cm)" value={items.table.length || ''} onChange={(e) => updateItem('table', { length: e.target.value })} className="w-24 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`p-4 border rounded-lg transition ${items.cupboard.active ? 'border-primary bg-primary-50 dark:bg-primary-900/20 dark:border-primary-500' : 'bg-white dark:bg-gray-700 dark:border-gray-600'}`}>
                        <label className="flex items-center gap-3 cursor-pointer text-gray-900 dark:text-gray-200">
                            ...
                            <span className="font-semibold">Schrank</span>
                        </label>
                        {items.cupboard.active && (
                            <div className="mt-2 ml-8 flex flex-wrap gap-4 items-center text-gray-700 dark:text-gray-300">
                                ...
                                <div className="flex gap-2 items-center">
                                    <span className="text-sm">Maße:</span>
                                    <input placeholder="Höhe" value={items.cupboard.height || ''} type="number" onChange={(e) => updateItem('cupboard', { height: e.target.value })} className="w-20 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                    <input placeholder="Breite" value={items.cupboard.width || ''} type="number" onChange={(e) => updateItem('cupboard', { width: e.target.value })} className="w-20 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                    <input placeholder="Tiefe" value={items.cupboard.depth || ''} type="number" onChange={(e) => updateItem('cupboard', { depth: e.target.value })} className="w-20 p-1 border border-gray-200 dark:border-gray-600 rounded bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-400" />
                                </div>
                            </div>
                        )}
                    </div>
            ...
            {/* Step 5: Contact */}
            <section className="space-y-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">5. Kontaktdaten</h3>
                <div className="grid md:grid-cols-2 gap-4">
                    <input required name="firstName" placeholder="Vorname" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                    <input required name="lastName" placeholder="Nachname" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                    <input required name="email" type="email" placeholder="E-Mail-Adresse" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                    <input required name="phone" type="tel" placeholder="Telefonnummer" className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" />
                </div>
                <textarea name="message" placeholder="Zusätzliche Nachricht / Anmerkungen..." className="w-full p-3 border border-gray-200 dark:border-gray-600 rounded-lg h-32 focus:ring-2 focus:ring-primary outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400"></textarea>
            </section>
            ...
            <button disabled={loading} type="submit" className="w-full bg-secondary hover:bg-secondary-hover text-white text-lg font-bold py-4 rounded-xl transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                {loading ? <Loader2 className="animate-spin" /> : 'Jetzt Angebot unverbindlich anfordern'}
            </button>
