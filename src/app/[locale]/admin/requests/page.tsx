        ...
        <div className="min-h-screen bg-[#0f172a] p-4 md:p-8 font-sans text-white transition-all duration-300">
            ...
            <div className="max-w-6xl mx-auto mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-4">
                    <Link href={`/${locale}/admin/users`} className="px-4 py-2 border border-[#FFC107] text-[#FFC107] rounded hover:bg-[#FFC107] hover:text-black transition flex items-center gap-2">
                        <Shield size={18} />
                        {t('admins')}
                    </Link>
                    <Link href={`/${locale}`} className="px-4 py-2 border border-[#FFC107] text-[#FFC107] rounded hover:bg-[#FFC107] hover:text-black transition flex items-center gap-2">
            ...
            <div className="max-w-6xl mx-auto">
                <div className="bg-[#1e293b] rounded-xl p-6 shadow-xl border border-gray-700">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            {requests.map((req) => (
                                <div key={req._id} className="bg-[#334155] p-4 rounded-lg flex flex-col md:flex-row justify-between items-center gap-4 border border-gray-600 hover:border-[#FFC107] transition group">
                                    <div className="flex-grow">
                                        <div className="flex justify-between md:justify-start gap-4 items-center mb-2 md:mb-0">
                                            <p className="font-bold text-white text-lg">
                                                {req.customer.firstName} {req.customer.lastName}
                                            </p>
                                            <span className="px-2 py-0.5 bg-blue-900 text-blue-200 rounded text-xs uppercase font-bold border border-blue-700">
                                                {req.moveType}
                                            </span>
                                        </div>
                                        ...
                                        <div className="text-gray-500 text-xs mt-2 flex items-center gap-4">
                            ...
                            {requests.length === 0 && (
                                <div className="text-center py-8 space-y-4">
                                    ...
                                    <div className="max-w-md mx-auto bg-[#334155] p-4 rounded-lg border border-dashed border-gray-500 opacity-70 hover:opacity-100 transition">
                                        <h3 className="text-[#FFC107] font-bold mb-2">Demo Mode</h3>
                                        <p className="text-sm text-gray-300 mb-4">No active requests? Try the invoice generator with sample data.</p>
                                        <Link
                                            href={`/${locale}/invoice?request_id=demo-request`}
                                            className="inline-block px-4 py-2 bg-gray-600 hover:bg-[#FFC107] hover:text-black text-white rounded transition text-sm font-bold"
                                        >
                                            Test Demo Request
                                        </Link>
                                    </div>
